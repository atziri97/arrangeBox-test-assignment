class ArrangeBoxControl extends HTMLElement {
  ...
  connectedCallback() {
    ...
    //Для примера, при создании нового инстанса будут генерироваться 25 случайных значений
    this.changeItems(this.generateRandomItems(25))
...
testAddInstance.addEventListener('click', () => {
  document.getElementById('arrangebox-container').appendChild(document.createElement('arrange-box'));
...
testGenerateNewRandomItems.addEventListener('click', () => arrangeBoxInstance.changeItems(arrangeBoxInstance.generateRandomItems(testInputValue)));
